...
var Heading = function (_Component) {
  ...
  _createClass(Heading, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _oneteamRteUtils.HEADER_BLOCK_TYPES.map(function (type) {
            return _react2.default.createElement(
              _MenuItem2.default,
              {
    ...
    value: function _createName(type) {
      ...
      return _oneteamRteUtils.HEADER_BLOCK_TYPES.some(function (t) {
        return t === type;
      }) ? name + ' ' + (0, _findKey2.default)(_oneteamRteUtils.BLOCK_TYPES, function (t) {
        return t === type;
      }).slice(1) : name + ' 1';
    }
  }]);
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Heading, 'Heading', 'src/ui/Heading.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/ui/Heading.js');
}();
