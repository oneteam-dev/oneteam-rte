...
var RichTextEditor = function (_Component) {
  ...
  _createClass(RichTextEditor, [{
    ...
    value: function _handleReturnSubmit(ev) {
      if (typeof this.props.onEnterKeyDown === 'function' && _draftJs.KeyBindingUtil.hasCommandModifier(ev)) {
    ...
    key: 'getSerializedBody',
    value: function getSerializedBody() {
      var contentState = this.state.editorState.getCurrentContent();
      var htmlBody = (0, _draftJsExportHtml.stateToHTML)(contentState, this.state.checkedState).replace(/figure/g, 'div').replace(/\n/g, '');
      var body = (0, _toMarkdown2.default)(htmlBody, { gfm: true }).replace(/<div>(.+)<\/div>\n/g, '$1\n').replace(/<div>(.+)<\/div>$/g, '$1');
...
RichTextEditor.propTypes = {
  ...
  toolbarButtonNodes: _react.PropTypes.objectOf(_react.PropTypes.node)
};