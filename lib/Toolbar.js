...
var Toolbar = function (_Component) {
  ...
  _createClass(Toolbar, null, [{
    ...
    get: function get() {
      return {
        editorState: _propTypes2.default.instanceOf(_draftJs.EditorState), // Required, but inherited from parent (RichTextEditor) component
        onChange: _propTypes2.default.func, // Required, but inherited from parent (RichTextEditor) component
        toggleInsertLinkInput: _propTypes2.default.func, // Required, but inherited from parent (RichTextEditor) component
        isOpenInsertLinkInput: _propTypes2.default.bool.isRequired,

        children: _propTypes2.default.node,
        onClickInsertImage: _propTypes2.default.func.isRequired,
        onClickUploadFile: _propTypes2.default.func.isRequired,
        onMouseDownEmbedIFrame: _propTypes2.default.func.isRequired,
        onHeadingToggled: _propTypes2.default.func.isRequired,
        itemOptions: _propTypes2.default.objectOf(_propTypes2.default.shape({
          description: _propTypes2.default.string,
          name: _propTypes2.default.string,
          iconNode: _propTypes2.default.node,
          activeIconNode: _propTypes2.default.node
        }))
      };
    }
  }, {
