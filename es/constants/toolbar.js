...
export var EMBED_IFRAME = 'EMBED_IFRAME';
export var INSERT_LINK = 'INSERT_LINK';
export var REMOVE_LINK = 'REMOVE_LINK';
export var DIVIDER = 'DIVIDER';
...
export var CHECKABLE_LIST = 'CHECKABLE_LIST';
export var UNOERDERD_LIST = 'UNOERDERD_LIST';
export var OERDERD_LIST = 'OERDERD_LIST';
export var CODE_BLOCK = 'CODE_BLOCK';
export var CODE = 'CODE';

export default (_INSERT_IMAGE$UPLOAD_ = {}, _defineProperty(_INSERT_IMAGE$UPLOAD_, INSERT_IMAGE, {
